...
export const VALIDATION_MESSAGE = {
  ...
  JOB_DESCRIPTION_REQUIRED: "Enter your job description.",
  JOB_DESCRIPTION_MAX: "Job description must be at most 5000 characters.",
  JOB_DESCRIPTION_MIN: "Job description must be at least 50 characters.",
  JOB_DESCRIPTION_VALID:
    "Job description must contain alpha & numeric characters only.",
  ...
  MIN_SKILLS: "At least one skill is required.",
  MAX_SKILLS: "At most five skills are allowed.",
